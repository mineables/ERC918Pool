...
var tasks = new Queue(async function (input, callback) {
    
    console.log('entering Queue: ', input)
...
module.exports = {
    ...
    async sendTransaction(account, mineableAddress, method) {
        await tasks.push({ web3: this.web3, account: account, mineableAddress: mineableAddress, method: method })
    },
